...
fn test_inversion_number() {
    let array = {
        let mut v = vec![];
        v.push((vec![3, 1, 5, 4, 2], 5));
        v.push((vec![3, 5, 2, 1, 4], 6));
        v.push((vec![3, 1, 2], 2));
        v.push((vec![6, 1, 5, 8, 2, 3, 4, 7], 12));
        v.push((vec![7, 6, 1, 5, 8, 2, 3, 10, 4, 9], 19));
        v.push((
            vec![
                63, 16, 24, 7, 29, 57, 65, 26, 36, 32, 50, 5, 34, 1, 18, 15, 49, 9, 47, 53, 10, 35,
                76, 79,
            ],
            122,
        ));
        v.push((
            vec![
                0, 18, 35, 2, 31, 33, 32, 6, 11, 15, 36, 19, 42, 23, 9, 20, 24, 3, 10, 47, 8, 38,
                5, 37, 46,
            ],
            125,
        ));
